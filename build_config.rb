...
MRuby::CrossBuild.new('android-x86') do |conf|
	params = {:arch => 'x86', platform: 'android-24', :toolchain => :clang}
	toolchain :android, params

	conf.gembox 'default'
end
MRuby::CrossBuild.new('android-x86_64') do |conf|
	params = {:arch => 'x86_64', platform: 'android-24', :toolchain => :clang}
	toolchain :android, params
...
MRuby::CrossBuild.new('android-arm64-v8a') do |conf|
	params = {:arch => 'arm64-v8a', platform: 'android-24', :toolchain => :clang}
	toolchain :android, params
